...
int app_main(void)
{
	...
	hx_drv_scu_set_PB6_pinmux(SCU_PB6_PINMUX_GPIO0_1);		// 7
	hx_drv_scu_set_PB7_pinmux(SCU_PB7_PINMUX_GPIO1_1);		// 8
	hx_drv_scu_set_PB8_pinmux(SCU_PB8_PINMUX_GPIO2_1);		// 3
	hx_drv_scu_set_PB11_pinmux(SCU_PB11_PINMUX_GPIO2);		// 2
